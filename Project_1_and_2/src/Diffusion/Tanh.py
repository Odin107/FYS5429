...
with open('runtime_Tanh.txt', 'w') as file:
...
plt.xlabel('Epoch')
plt.ylabel('Loss')
plt.savefig(os.path.join(figures_dir, f'loss_Tanh.png'))
plt.close()
...
plt.xlabel('x')
plt.ylabel('y')
plt.savefig(os.path.join(figures_dir, 'initial_condition_Tanh.png'))
plt.close()
...
for t in time_points:
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(figures_dir, f'solution_Tanh_t_{t}.png'))
    plt.close
